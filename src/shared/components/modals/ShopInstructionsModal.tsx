import type { ShopInstructionsModalProps } from "@/shared/types/props/ShopInstructionsModalProps"

const ShopInstructionsModal = ({ onClose, activeModal }: ShopInstructionsModalProps) => {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
            <div className="bg-[var(--bg-primary)] border border-[var(--border)] rounded-2xl shadow-lg p-6 max-w-lg w-[90%] space-y-4 text-[var(--text-primary)] text-sm leading-relaxed overflow-y-auto max-h-[90vh] hide-scrollbar relative">
                <h2 className="text-base font-semibold text-center">📘 Shop Instructions</h2>
...
export default ShopInstructionsModal
